...
summary function. All regression coefficients are included in summary by
...
using exponentiate=TRUE option. The summaries can be displayed in Viewer
...
suppressed when report.nuisance.parameter = TRUE is not specified.
...
competing events (outcome.type=‘COMPETINGRISK’). Here 15 covariates and
