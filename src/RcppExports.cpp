...
RcppExport SEXP _cif_calculateKM(SEXP tSEXP, SEXP dSEXP, SEXP wSEXP, SEXP strataSEXP, SEXP errorSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_cif_calculateKM", (DL_FUNC) &_cif_calculateKM, 5},
    {NULL, NULL, 0}
};

RcppExport void R_init_cif(DllInfo *dll) {
