---
title: "Package cif: getting started"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Package cif: getting started}
...
### Comparison of `model formula` and `outcome.type` across `cif_curve()` and `cif_reg()`
...
### Processing pipeline of `cif_reg()`
